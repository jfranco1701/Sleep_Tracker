    ...
    public void onDeviceSelected(final BluetoothDevice btDevice) {
        ...
        mwBoard.setConnectionStateHandler(new MetaWearBoard.ConnectionStateHandler() {
            ...
            public void connected() {
                ...
                Intent logIntent = new Intent(ScannerActivity.this, LogActivity.class);
                logIntent.putExtra(LogActivity.EXTRA_BT_DEVICE, btDevice);
                startActivityForResult(logIntent, REQUEST_START_APP);
            }
